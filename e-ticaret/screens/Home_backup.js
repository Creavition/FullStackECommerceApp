...
export default function Home() {
    ...
    const loadProducts = useCallback(async () => {
        ...
        try {
            ...
            console.log(`Loaded ${products.length} products and ${categoryList.length} categories`);
        } catch (e) {
    ...
    const flashSaleProducts = useMemo(() => {
        const ids = new Set();
        const categoryList = categories.length > 0 ? categories : ['Jacket', 'Pants', 'Shoes', 'T-Shirt'];
