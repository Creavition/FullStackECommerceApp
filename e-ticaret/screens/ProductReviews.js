...
const ProductReviews = () => {
    ...
    const fetchReviews = async () => {
        try {
            const response = await fetch(`http://192.168.1.3:5207/api/Review/Product/${productId}`);
    ...
    const fetchReviewStats = async () => {
        try {
            const response = await fetch(`http://192.168.1.3:5207/api/Review/Stats/${productId}`);
